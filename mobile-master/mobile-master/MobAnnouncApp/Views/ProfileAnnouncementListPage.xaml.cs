...
{
    public partial class ProfileAnnouncementListPage : ContentPage
    {
        private UserService UserService = new UserService();
        private PageData Response { get; set; }
        private bool IsFirstLoad { get; set; } = true;

        public ProfileAnnouncementListPage()
        {
            InitializeComponent();
        ...
        {
            var result = await UserService.FetchAnnouncements(offset, length);
        ...
        {
            var item = (PageData.Announcement)e.Item;
