...
using Xamarin.Forms;
using static MobAnnouncApp.Responses.User.LikeListResponse;

namespace MobAnnouncApp.Views
{
    public partial class ProfileLikeListPage : ContentPage
    {
        private UserService UserService = new UserService();
        private PageData Response { get; set; }
        private bool IsFirstLoad { get; set; } = true;

        public ProfileLikeListPage()
        {
            InitializeComponent();
        ...
        {
            var result = await UserService.FetchLikes(offset, length);
            ...
            AnnouncementList.ItemsSource = Response.Likes;
            InitialPagination();
